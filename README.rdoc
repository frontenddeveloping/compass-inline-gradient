...
It convert css linear gradient syntax to data uri (base64) background-image.

=== Why use base64 background-images not native gradient?
Native css gradients have a lot of prefixes, you must use filters for IE, and IE9 and Opera needs inline svg gradients.
...
See "example" folder in git repo for ready examples.
